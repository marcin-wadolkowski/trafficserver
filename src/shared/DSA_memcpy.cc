...
// Function which is a replacement for memcpy, currently fills call_counts map 
// with the data (for testing purposes)
void *DSA_memcpy::memcpy(void *dest, const void *src, size_t n, 
...
void DSA_memcpy::print_counts(std::string filename) {
